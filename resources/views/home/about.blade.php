<div class="container-fluid position-relative my-5 overflow-hidden">
        <img src="{{ asset('images/icone-cercle-jaune.png') }}" alt="lamp gradient" class="icone-cercle-haut">
    <div class="container">
            ...
            <div class="row position-relative">
                ...
                <div class="col-6">
                    <div class="about-desc">
                        ...
                        <button class="btn btn-voir-plus">Voir le menu</button>
                    </div>
                </div>
            </div>
        </div>
